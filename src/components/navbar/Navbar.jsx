    ...
    return (
        <nav className="navbar navbar-expand-md bg-body py-3">
            <div className="container">
                ...
                <div className="d-none d-md-block"><button className="btn btn-light me-2" type="button">Registrate</button><a className="btn btn-primary" role="button" href="#">Iniciar Sesión</a></div>
            </div>
        </nav>
    );
};
