...
const Footer = () => {
    return (
        <footer className="text-center bg-body py-4">
        <div className="container ">
            <div className="row row-cols-1  row-cols-lg-3">
                <div className="col">
                    <p className="text-muted my-2">Copyright&nbsp;© 2025 Pura Vida 23 C.A</p>
                </div>
                <div className="col">
                ...
                <div className="col">
                    <ul className="list-inline my-2">
                        <li className="list-inline-item"><a className="link-secondary" href ="#">Política de Privacidad</a></li>
                        <li className="list-inline-item"><a className="link-secondary" href="#">Terminos de Uso</a></li>
                    </ul>
                </div>
            </div>
        </div>
